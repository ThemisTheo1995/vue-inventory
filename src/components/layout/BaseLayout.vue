...
<template>
  <div class="flex h-[100dvh] overflow-hidden bg-slate-50/50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 transition-colors duration-300 font-sans">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <header class="sticky top-0 z-30 flex items-center px-4 md:px-8 py-2 md:py-3 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b-2 border-slate-200/70 dark:border-slate-800/70">
